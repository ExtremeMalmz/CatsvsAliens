...
def winning_screen_main():
    ...
    winningMessage = font.render(
        "Congratulations you won the game!", True, (25, 255, 255))
    #playerName = font.render("Player name", True, (25, 255, 255))

    thankYouMessage = font.render(
        "Thanks for playing Cats vs Aliens", True, (25, 255, 255))
    ...
    quitMessage = font.render(
        "The game doesn't close by itself -Management", True, (229, 20, 29))
    timer = 0

    mixer.music.load(os.path.join(
        'MusicVideos', 'ARelatoinshipWithTheCatlime.wav'))
    mixer.music.play(-1)
    ...
    while True:
        ...
        if timer >= 0 and timer <= 2000:
            ...
            #screen.blit(playerName, 300,300)

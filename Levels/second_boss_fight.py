...
def second_boss_fight_main():
    ...
    pygame.display.set_caption('Boss Fight 1')
    ...
    # STUFF I HAVE ADDED
    boss_image = pygame.image.load(os.path.join(
        'Assets', 'SecondBoss.png')).convert()
    boss_image.set_colorkey((0, 0, 0))
    boss_rect = pygame.Rect(64, 162, 64, 32)
    ...
    while True:  # game loop
        ...
        display.fill((151, 120, 120))  # clear screen by filling it with blue
            ...
            if event.type == KEYDOWN:
                ...
                if event.key == K_DOWN or event.key == K_s:
                    player_rect = pygame.Rect(
                        playerXcoordinate, playerYcoordinate, 16, 14)
        ...
        display.blit(boss_image, (boss_rect.x -
                     scroll[0], boss_rect.y-scroll[1]))

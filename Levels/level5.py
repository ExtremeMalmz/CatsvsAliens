...
def level_5_game_loop():
    ...
    while True:  # game loop
        ...
        display.fill((82, 192, 255))  # clear screen by filling it with blue
        ...
        for layer in game_map:
            ...
            for tile in layer:
                ...
                if tile == '2':
                    display.blit(
                        whitesnow_img, (x*16-scroll[0], y*16-scroll[1]))
                if tile == '3':
                    display.blit(
                        flag_image, (x * 16-scroll[0], y * 16-scroll[1]))
                if tile == '4':
                    display.blit(
                        blo_image, (x * 16-scroll[0], y * 16-scroll[1]))
                if tile == '5':
                    display.blit(
                        snow5_img, (x * 16-scroll[0], y * 16-scroll[1]))
                if tile == '6':
                    display.blit(snowrock_image,
                                 (x * 16-scroll[0], y * 16-scroll[1]))
                if tile == '7':
                    display.blit(
                        snowd_image, (x * 16-scroll[0], y * 16-scroll[1]))
                if tile != '0':

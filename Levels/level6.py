...
def level_6_game_loop():
    ...
    whitesnow1_image = pygame.image.load(
        os.path.join('Assets', 'whitesnow1.jpeg'))
    ...
    while True:
        ...
        for layer in game_map:
            ...
            for tile in layer:
                if tile == '1':
                    display.blit(
                        golden1_image, (x*16-scroll[0], y*16-scroll[1]))
                if tile == '2':
                    display.blit(whitesnow1_image,
                ...
                if tile == '5':
                    display.blit(
                        golden1_image, (x * 16-scroll[0], y * 16-scroll[1]))
                if tile == '6':
                    display.blit(block1_image(
                        x * 16-scroll[0], y * 16-scroll[1]))
                if tile == '7':
                    display.blit(
                        tree_image, (x * 16-scroll[0], y * 16-scroll[1]))
                if tile != '0':

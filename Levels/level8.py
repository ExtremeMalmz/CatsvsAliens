...
def level_8_game_loop():
    ...
    istockphoto_image = pygame.image.load(
        os.path.join('Assets', 'istockphoto.jpeg'))
    ...
    while True:
        ...
        for layer in game_map:
            ...
            for tile in layer:
                if tile == '1':
                    display.blit(istockphoto_image,
                                 (x*16-scroll[0], y*16-scroll[1]))
                if tile == '2':
                    display.blit(
                        jelly_image, (x * 16-scroll[0], y * 16-scroll[1]))
                if tile == '3':
                    display.blit(
                        flag_image, (x * 16-scroll[0], y * 16-scroll[1]))
                if tile == '4':
                    display.blit(
                        blocks1_image, (x * 16-scroll[0], y * 16-scroll[1]))
                if tile == '5':
                    display.blit(istockphoto_image,
                                 (x * 16-scroll[0], y * 16-scroll[1]))
                if tile == '6':
                ...
                if tile == '7':
                    display.blit(
                        tree2_image, (x * 16-scroll[0], y * 16-scroll[1]))
                if tile != '0':

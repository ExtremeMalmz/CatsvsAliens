...
def send_to_level_2():
    '''
    Sends the program back to the main menu file
    '''
...
def level_2_game_loop():
    ...
    whitebricks_image = pygame.image.load('whitebricks.jpg')
    ...
    #First number is how fast it moves away from the player - Second is x coordinate - Third is y coordinate
    background_objects = [[0.25,[120,10,100,400]], [0.50,[280,30,100,300]], [0.50,[180,130,200,300]]]
    ...
    while True: # game loop
        ...
        display.fill((195,92,106)) # clear screen by filling it with blue
        ...
        for background_object in background_objects:
            ...
            if background_object[0] == 0.5:
                ...
                pygame.draw.rect(display,(190,202,85),obj_rect)
